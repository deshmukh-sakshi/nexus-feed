                ...
                <tr key={comment.id} className={idx % 2 === 0 ? 'bg-yellow-50' : 'bg-white'}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Link to={`/post/${comment.postId}`} target="_blank" className="p-2 bg-blue-400 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-blue-500 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all">
                        <ExternalLink className="h-4 w-4" />
                      </Link>
                      {deleteConfirm === comment.id ? (
                        <div className="flex gap-2">
                          <button onClick={() => handleDelete(comment.id)} className="px-3 py-1 bg-red-500 text-white border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-red-600 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all">Confirm</button>
                        ...
                        <button onClick={() => setDeleteConfirm(comment.id)} className="p-2 bg-red-400 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:bg-red-500 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all">
