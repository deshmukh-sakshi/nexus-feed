      ...
      <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
        <table className="w-full">
          <thead className="bg-green-400 border-b-4 border-black">
            <tr>
              <th className="px-4 py-3 text-left font-black">Comment</th>
              <th className="px-4 py-3 text-left font-black">Author</th>
              <th className="px-4 py-3 text-left font-black">Post</th>
              ...
              <tr key={comment.id} className={idx % 2 === 0 ? 'bg-yellow-50' : 'bg-white'}>
                ...
                <td className="px-4 py-3">
                  <span className={`px-2 py-1 border-2 border-black font-bold text-sm ${
                    comment.upvotes - comment.downvotes >= 0 ? 'bg-green-300' : 'bg-red-300'
                  }`}>
