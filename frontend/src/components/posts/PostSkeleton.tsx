...
export const PostSkeleton = () => {
  return (
    <Card className="flex flex-col overflow-hidden border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] rounded-none bg-yellow-50 py-0 gap-0">
      {/* Content Area */}
      <div className="px-4 pt-2 pb-1">
        ...
        {/* Title */}
        <Skeleton className="h-8 w-2/3 rounded-none bg-muted-foreground/20 mb-1" />
